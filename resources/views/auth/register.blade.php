...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="route('front.index')" class="h1"><b>Blog</b>Site</a>
    ...
    <div class="card-body">
      ...
      <form action="{{ route('register') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input class="form-control" placeholder="Retype password"   type="password" name="password_confirmation" required autocomplete="new-password">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
      ...
      <div class="mt-3">
      <a href="/login" class="text-center">I already have a membership. Go to Login page </a>
    </div>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
